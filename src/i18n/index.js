...
const translations = {
  'zh-CN': {
    ...
    pageDescription: 'Wilcox - 订阅链接转换工具',
    pageKeywords: '订阅链接,转换,Xray,SingBox,Clash,Surge',
    pageTitle: 'Wilcox - 订阅链接转换工具',
    ogTitle: 'Wilcox - 订阅链接转换工具',
  ...
  'en-US': {
    ...
    pageDescription: 'Wilcox - Subscription Link Converter',
    pageKeywords: 'subscription link,converter,Xray,SingBox,Clash,Surge',
    pageTitle: 'Wilcox - Subscription Link Converter',
    ogTitle: 'Wilcox - Subscription Link Converter',
  ...
  'fa': {
    ...
    pageDescription: 'Wilcox - مبدل لینک اشتراک',
    pageKeywords: 'لینک اشتراک,مبدل,Xray,SingBox,Clash,Surge',
    pageTitle: 'Wilcox - مبدل لینک اشتراک',
    ogTitle: 'Wilcox - مبدل لینک اشتراک',
